...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀          
    ...
    #print(Fore.LIGHTGREEN_EX+"{/} "+Style.RESET_ALL+"Katkıda bulunanlar: "+Fore.LIGHTGREEN_EX+Style.BRIGHT+",\n"+Style.RESET_ALL)
    try:
    ...
    if menu == 1:
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Telefon Numarası (+90): "+ Fore.LIGHTGREEN_EX, end="")
            tel_no = input()
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail adresi (Geçmek için enter bas): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Çıkış yapyıor...")
        break
